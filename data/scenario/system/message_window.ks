;メッセージレイヤの定義
		...
		[position width=920 height=200 top=400 left=20 ]
			...
			[position page=fore margint=45 marginl=10 marginr=20 marginb=10 vertical=false opacity="230" radius="0" color="0x000000" ]
		...
		[position layer="message1" width=920 height=200 top=400 left=20 ]
		[position layer="message1" page=fore margint=5 marginl=10 marginr=10 marginb=10 vertical=false opacity="230" radius="0" color="0x000000" ]
